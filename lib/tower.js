var Tower = function(player, position, tower_type) {
  ...
  this.rate = tower_type == 'type1' ? 0.5 : 0.25;
  this.range = tower_type == 'type1' ? 96 : 112;
  this.damage = tower_type == 'type1' ? 1 : 3;
  this.level = 1;
