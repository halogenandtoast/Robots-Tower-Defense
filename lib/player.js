...
Player.prototype = {
  ...
  upgrade_robots: function(request) {
    ...
    if(this.cash >= upgrade_cost) {
      ...
      this.upgrade_costs[request.robot_type] = this.upgrade_cost[request.robot_type] * 2.25;
    }
